...
router.get('/', verifyToken, HasRole(['Admin']), (req, res) => {
  ClinicController.list(req, res);
});

/*
 * GET
 */
router.get('/me', verifyToken, HasRole(['Admin', 'Clinic']), (req, res) => {
  ClinicController.show(req, res);
});
 ...
 * PUT
 */
router.put('/', verifyToken, HasRole(['Admin', 'Clinic']), (req, res) => {
  ClinicController.update(req, res);
});

/*
 * DELETE
 */
router.delete('/', verifyToken, HasRole(['Admin', 'Clinic']), (req, res) => {
  ClinicController.remove(req, res);
});
